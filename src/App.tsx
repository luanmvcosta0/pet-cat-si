    ...
    <div className="h-screen bg-[#0D0D14] flex flex-col items-center justify-between overflow-hidden px-6 py-6 relative">
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center gap-10 md:gap-16 w-full max-w-4xl">
        ...
        <div className="flex flex-col items-center gap-5 max-w-[220px] text-center">
          <div className="w-48 h-16 rounded-xl border border-[#E0234E]/30 bg-[#E0234E]/8 flex items-center justify-center px-4 py-2">
            <img
              src="/nest-logo.png"
              alt="Logo NestJS"
        ...
        {/* Right: cat */}
        <div className="scale-75 md:scale-90 origin-center flex-shrink-0">
          <NestCat />
        </div>
      </div>
    </div>
